Pod::Spec.new do |s|
    ...
    s.source_files = 'ios/build/out/ghclient.framework/Headers/*.h'
    s.public_header_files = 'ios/build/out/ghclient.framework/Headers/*.h'
    s.vendored_frameworks = 'ios/build/out/ghclient.framework'
